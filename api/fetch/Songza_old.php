...
$url = (isset($_POST["url"]) ? $_POST["url"] : "http://songza.com/listen/electronic-all-nighter-SamsungMobileUSA/");
$stationId = (isset($_POST["stationId"]) ? $_POST["stationId"] : "1718994");
...
if (isset($stationArray)) {
	$output = json_encode(array_merge($stationArray, $songArray, $error));
} else {
	$output = json_encode(array_merge($songArray, $error));
}
